...
reader-first: local filesystems, HTTP/HTTPS, S3, GCS, and Azure Blob object
stores are supported by default.
...
For private cloud buckets, set the standard provider environment variables
before calling `open()`:
